...
for (i in 1:max_iteration){
  ...
  ws_crowns <- lastrees(las, mcwatershed(chm = chm,treetops = TT,  th_tree = thTree, ID = "treeID"))
...
mcws_tune <- as.data.frame(cbind(iterate, TH_Tree, TT_ws, TT_hmin,Acc,nMC, nAC, 
                                     P1,P2,P3,P4,P5,P6,P7,P8,P9,
                                     P10,P11,P12,P13,P14,P15))
                                    


write.csv(mcws_tune, "mcWS_tune_300buf.csv")
